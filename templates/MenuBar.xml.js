...
<document>
  <menuBarTemplate>
    <menuBar>
      <menuItem template="${this.BASEURL}templates/DynFeatured.xml.js" elementType="menu" dynContent="https://dl.dropboxusercontent.com/u/11080772/films.json" presentation="menuBarItemPresenter">
        <title>Featured</title>
      </menuItem>
      <menuItem template="${this.BASEURL}templates/Stack_Room.xml.js" elementType="menu" dynContent="https://dl.dropboxusercontent.com/u/11080772/films.json" presentation="menuBarItemPresenter">
        <title>All</title>
      </menuItem>
    </menuBar>
  </menuBarTemplate>
